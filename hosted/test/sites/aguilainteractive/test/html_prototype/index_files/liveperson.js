...
try {
    if (typeof(lpUnit) == "undefined") var lpUnit = 'istock';
...
if (typeof(lpMTagConfig.dynButton) != "undefined") {
    lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {
        "name": "chat-" + lpUnit + "-" + lpLanguage + "-header",
        "pid": "lpHeader",
        "afterStartPage": true
    };
    lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {
        "name": "chat-" + lpUnit + "-" + lpLanguage + "-footer",
        "pid": "lpFooter",
        "afterStartPage": true
    };
}
if (typeof(lpSignupFlag) != "undefined") {
    lpAddVars('session', 'SignupFlag', lpSignupFlag);
}
if (typeof(lpLoginFlag) != "undefined") {
    lpAddVars('session', 'LoginFlag', lpLoginFlag);
}
if (typeof(lpMemberName) != "undefined") {
    lpAddVars('session', 'MemberName', lpMemberName);
}
if (typeof(lpMemberFirstName) != "undefined") {
    lpAddVars('session', 'MemberFirstName', lpMemberFirstName);
}
if (typeof(lpMemberLastName) != "undefined") {
    lpAddVars('session', 'MemberLastName', lpMemberLastName);
}
if (typeof(lpMemberType) != "undefined") {
    lpAddVars('session', 'MemberType', lpMemberType);
}
if (typeof(lpAccountType) != "undefined") {
    lpAddVars('session', 'AccountType', lpAccountType);
}
if (typeof(lpVisitorID) != "undefined") {
    lpAddVars('session', 'VisitorID', lpVisitorID);
}
if (typeof(lpFrameFlag) != "undefined") {
    lpAddVars('page', 'FrameFlag', lpFrameFlag);
}
if (typeof(lpDivFlag) != "undefined") {
    lpAddVars('page', 'DivFlag', lpDivFlag);
}
if (typeof(lpCurrencyType) != "undefined") {
    lpAddVars('page', 'CurrencyType', lpCurrencyType);
}
if (typeof(lpCartTotal) != "undefined") {
    lpAddVars('page', 'CartTotal', lpCartTotal);
}
if (typeof(lpCartCount) != "undefined") {
    lpAddVars('page', 'CartCount', lpCartCount);
}
if (typeof(lpOfferCode) != "undefined") {
    lpAddVars('page', 'OfferCode', lpOfferCode);
}
if (typeof(lpCheckoutTypeSelected) != "undefined") {
    lpAddVars('page', 'CheckoutTypeSelected', lpCheckoutTypeSelected);
}
if (typeof(lpUpload_OrderNumber) != "undefined") {
    lpAddVars('page', 'Upload_OrderNumber', lpUpload_OrderNumber);
}
if (typeof(lpDownload_OrderNumber) != "undefined") {
    lpAddVars('page', 'Download_OrderNumber', lpDownload_OrderNumber);
}
if (typeof(lpDownload_OrderTotal) != "undefined") {
    lpAddVars('page', 'Download_OrderTotal', lpDownload_OrderTotal);
}
if (typeof(lpCreditWalletValue) != "undefined") {
    lpAddVars('page', 'CreditWalletValue', lpCreditWalletValue);
}
if (typeof(lpStoreCheckout_CurrencyType) != "undefined") {
    lpAddVars('page', 'StoreCheckout_CurrencyType', lpStoreCheckout_CurrencyType);
}
if (typeof(lpStoreCheckout_OrderCount) != "undefined") {
    lpAddVars('page', 'StoreCheckout_OrderCount', lpStoreCheckout_OrderCount);
}
if (typeof(lpStoreCheckout_OrderTotal) != "undefined") {
    lpAddVars('page', 'StoreCheckout_OrderTotal', lpStoreCheckout_OrderTotal);
}
if (typeof(lpStoreCheckout_OrderNumber) != "undefined") {
    lpAddVars('page', 'StoreCheckout_OrderNumber', lpStoreCheckout_OrderNumber);
}
if (typeof(lpStoreCheckoutStage) != "undefined") {
    lpAddVars('page', 'StoreCheckoutStage', lpStoreCheckoutStage);
}